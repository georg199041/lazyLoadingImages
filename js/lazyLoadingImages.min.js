(function(f){var f=f||window,i={addEvent:function(a,b,d){a.addEventListener?a.addEventListener(b,d,!1):a.attachEvent&&a.attachEvent("on"+b,d)}},e={node:{},images:[],scroll:{type:[],on:!1,timer:null,event:!1},addImage:function(a,b,d){var c=a.getAttribute("data-type");this.images.push({id:d,node:a,url:b,type:c||!1,image:null,isLoad:!1,isShow:!1,callback:null,offset:a.offsetTop})},showImage:function(a){a=this.images[a];a.node.src=a.image.src;a.isLoad=!0;a.isShow=!0},load:function(a){this.loadAndShow(a,
